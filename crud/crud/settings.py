...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 3      # указания количество элементов на 1 странице. После добавления пагинации, на запрос не будут выдаваться все результаты, а только заданное количество
}
